    ...
    <footer className="container mx-auto mt-10 flex flex-col gap-8 border-t-2 p-5 lg:flex-row lg:justify-between lg:gap-5 lg:px-0">
      <div className="flex flex-col gap-8 lg:w-1/2">
        <p className="text-2xl font-semibold">
          ...
          at sunt, eaque consequatur labore iste possimus laboriosam repellendus
          praesentium dignissimos hic voluptas quia voluptatibus, ducimus
          dolores corporis nulla tempora.
        </p>
